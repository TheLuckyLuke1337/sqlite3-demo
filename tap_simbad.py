...
def tap_simbad(radius=15.33) -> Table:
    ...
    result_keys = ["oid", "x", "y", "z", "flux_v",
                   "temperature", "sp_type", "main_id"]
    table_keys = ["oid", "x", "y", "z", "avg_v",
                  "avg_temperature", "sp_type", "main_id"]
